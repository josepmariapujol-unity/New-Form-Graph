...
{
    [Serializable]
    public class FormRectangleXZFloat : FormOperator
    {
        public override string Title
        {
            get => "Rectangle XZ (float)";
            set { }
        }
        ...
        public override float Evaluate()
        {
            ...
            {
                var node_1 = new Vector3(Values[0] - Values[0], Values[3] + i, Values[1] - Values[1]) + position;
                var node_2 = new Vector3(Values[0], Values[3] + i, Values[1] - Values[1]) + position;
                var node_3 = new Vector3(Values[0], Values[3] + i, Values[1]) + position;
                var node_4 = new Vector3(Values[0] - Values[0], Values[3] + i, Values[1]) + position;
