...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Samples.MathBook
{
    ...
    {
        public static IModelUI CreateNodeInspector(this ElementBuilder elementBuilder, CommandDispatcher commandDispatcher, FormOperator model)
        {
            ...
            var mathOpInspectorFields = FormOperatorInspector.Create("mathop-fields", model, ui, ModelInspector.ussClassName);
